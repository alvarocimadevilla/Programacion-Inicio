...
public class AgenteDAO {
    ...
    public AgenteDAO(){
        ...
        if (agentes == null) {
            ...
            agentes.add(new Empleado("09125499L","Ada", "Lovelace", LocalDate.of(2001, 05, 1), DEPARTAMENTOS.CONSULTORIA));
            agentes.add(new Empleado("12345B","Grace", "Hoper", LocalDate.of(2001, 03, 1), DEPARTAMENTOS.CONTABILIDAD));
            agentes.add(new Cliente("InnovateTech Solutions","Calle de la Innovación, 123",LocalDate.of(2024, 01, 1)));
            agentes.add(new Empleado("C12345678","Elon", "Musk", LocalDate.of(2001, 01, 1), DEPARTAMENTOS.DESARROLLO));
            agentes.add(new Empleado("12345678D","Steve", "Jobs", LocalDate.of(2001, 06, 1)));
