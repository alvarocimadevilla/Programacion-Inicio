...
public class ProductoDAO {
    ...
    public ProductoDAO(){
        ...
        // 1º: LocalDate: el método estático LocalDate.of() devuelve un objeto LocalDate con la fecha
        // 2º: numeroLote
        // 3º: dependiendo del tipo de producto será: temperaturaCongelacion, paisOrigen, codigoSupervision
